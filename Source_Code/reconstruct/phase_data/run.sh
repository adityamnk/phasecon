...
mpiexec -n 1 -machinefile nodefile ./XT_Main --proj_rows 64 --proj_cols 64 --proj_num 64 --recon_num 1 --vox_wid 1 --rot_center 32 --sig_s 1 --sig_t 1 --c_s 0.000001 --c_t 0.000001 --convg_thresh 1
