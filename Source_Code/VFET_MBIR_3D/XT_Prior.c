...
void matinv (Real_t matin[2][2], Real_t matout[2][2])
{
	Real_t det;
	det = matin[0][0]*matin[1][1] - matin[0][1]*matin[1][0] + EPSILON_ERROR;
	matout[0][0] = matin[1][1]/det;
	matout[1][1] = matin[0][0]/det;
	matout[0][1] = -matin[0][1]/det;
	matout[1][0] = -matin[1][0]/det;
}
...
void FunctionalSubstitution(Real_t *VMag, Real_t *VElec, Real_t THETA1_Mag[2], Real_t THETA2_Mag[2][2], Real_t THETA1_Elec, Real_t THETA2_Elec, ScannedObject* ScannedObjectPtr, TomoInputs* TomoInputsPtr, Real_t Mag_Nhood[3][3][3][2], Real_t Elec_Nhood[3][3][3], bool BDFlag[3][3][3])
{
  Real_t u_mag[2], u_elec, temp1_mag[2], temp1_elec, temp2_mag[2][2], temp2_elec, Delta0_Mag[2], Delta0_Elec;
  Real_t QGGMRF_Params_Mag[2], QGGMRF_Params_Elec;
  int32_t i,j,k,l;

  temp1_mag[0] = 0; temp1_mag[1] = 0; temp1_elec = 0;
  temp2_mag[0][0] = 0; temp2_mag[0][1] = 0; 
  temp2_mag[1][0] = 0; temp2_mag[1][1] = 0; 
  temp2_elec = 0;
  ...
  temp1_mag[0] = (temp1_mag[0] + (THETA2_Mag[0][0]*VMag[0] + THETA2_Mag[0][1]*VMag[1]) - THETA1_Mag[0]);
  temp1_mag[1] = (temp1_mag[1] + (THETA2_Mag[1][0]*VMag[0] + THETA2_Mag[1][1]*VMag[1]) - THETA1_Mag[1]);
  ...
  u_mag[0] = temp1_mag[0]*temp2_mag[0][0] + temp1_mag[1]*temp2_mag[0][1];
  u_mag[1] = temp1_mag[0]*temp2_mag[1][0] + temp1_mag[1]*temp2_mag[1][1];
