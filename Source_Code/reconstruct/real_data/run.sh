...
./XT_Main --proj_rows 256 --proj_cols 256 --proj_num 71 --vox_wid 3.2 --qggmrf_sigma 0.0001 --qggmrf_c 0.000001 --convg_thresh 0.001 --admm_mu 100000000 --admm_maxiters 20 --x_widnum 512 --y_widnum 512 --z_widnum 64
