...
#mpiexec -n 1 -machinefile nodefile ./XT_Main --proj_rows 32 --proj_cols 128 --proj_num 1 --recon_num 1 --vox_wid 0.7 --rot_center 64 --mag_sig_s 0.000005 --mag_sig_t 1 --mag_c_s 0.000001 --mag_c_t 0.000001 --phase_sig_s 0.0000015 --phase_sig_t 1 --phase_c_s 0.000001 --phase_c_t 0.000001 --convg_thresh 1 --obj2det_dist 400000 --xray_energy 3 --pag_regparam 97.8734 --gen_data > debug_data.log
#mpiexec -n 1 -machinefile nodefile ./XT_Main --proj_rows 32 --proj_cols 128 --proj_num 1 --recon_num 1 --vox_wid 0.7 --rot_center 64 --mag_sig_s 0.0005 --mag_sig_t 1 --mag_c_s 0.000001 --mag_c_t 0.000001 --phase_sig_s 0.0001 --phase_sig_t 1 --phase_c_s 0.000001 --phase_c_t 0.000001 --convg_thresh 1 --obj2det_dist 400000 --xray_energy 3 --pag_regparam 97.8734 --pag_mbir > debug_pag.log 
mpiexec -n 1 -machinefile nodefile ./XT_Main --proj_rows 32 --proj_cols 128 --proj_num 1 --recon_num 1 --vox_wid 0.7 --rot_center 64 --mag_sig_s 0.1 --mag_sig_t 1 --mag_c_s 0.000001 --mag_c_t 0.000001 --phase_sig_s 20 --phase_sig_t 1 --phase_c_s 0.000001 --phase_c_t 0.000001 --convg_thresh 1 --obj2det_dist 400000 --xray_energy 3 --pag_regparam 98 --critir > debug_critir.log
