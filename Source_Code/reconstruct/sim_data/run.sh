...
./XT_Main --proj_rows 128 --proj_cols 128 --proj_x_num 71 --proj_y_num 71 --vox_wid 5 --qggmrf_sigma 0.00001 --qggmrf_c 0.000001 --convg_thresh 0.01 --admm_mu 1000000000 --admm_maxiters 20 --x_widnum 128 --y_widnum 128 --z_widnum 32 --data_variance 0.00004
