...
./XT_Main --proj_rows 128 --proj_cols 128 --proj_x_num 71 --proj_y_num 71 --vox_wid 5 --qggmrf_sigma 0.0001 --qggmrf_c 0.000001 --convg_thresh 0.001 --admm_mu 1000000 --admm_maxiters 10 --x_widnum 128 --y_widnum 128 --z_widnum 64

#./XT_Main --proj_rows 256 --proj_cols 256 --proj_x_num 101 --proj_y_num 21 --vox_wid 6 --qggmrf_sigma 0.00001 --qggmrf_c 0.000001 --convg_thresh 0.01 --admm_mu 10000000 --admm_maxiters 20 --x_widnum 512 --y_widnum 512 --z_widnum 64
