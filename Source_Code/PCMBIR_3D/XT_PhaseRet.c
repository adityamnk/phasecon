...
void compute_phase_projection (Real_arr_t** y_real, Real_arr_t** y_imag, Real_arr_t** Omega_real, Real_arr_t** Omega_imag, Real_arr_t** D_real, Real_arr_t** D_imag, Real_arr_t** w_real, Real_arr_t** w_imag, int32_t rows, int32_t cols, Real_t delta_rows, Real_t delta_cols, fftw_complex* fftforw_arr, fftw_plan* fftforw_plan, fftw_complex* fftback_arr, fftw_plan* fftback_plan) 
{
	...
	compute_FresnelTran (rows, cols, delta_rows, delta_cols, fftforw_arr, fftforw_plan, fftback_arr, fftback_plan);
...
void mult_Herm_OmegaHD (Real_arr_t** y_real, Real_arr_t** y_imag, Real_arr_t** Omega_real, Real_arr_t** Omega_imag, Real_arr_t** D_real, Real_arr_t** D_imag, int32_t rows, int32_t cols, Real_t delta_rows, Real_t delta_cols, fftw_complex* fftforw_arr, fftw_plan* fftforw_plan, fftw_complex* fftback_arr, fftw_plan* fftback_plan)
{
	int32_t i, j;
	Real_t real, imag;
	...
	compute_HermFresnelTran (rows, cols, delta_rows, delta_cols, fftforw_arr, fftforw_plan, fftback_arr, fftback_plan);
...
void mult_OmegaHD (Real_arr_t** y_real, Real_arr_t** y_imag, Real_arr_t** Omega_real, Real_arr_t** Omega_imag, Real_arr_t** D_real, Real_arr_t** D_imag, int32_t rows, int32_t cols, Real_t delta_rows, Real_t delta_cols, fftw_complex *fftforw_arr, fftw_plan *fftforw_plan, fftw_complex *fftback_arr, fftw_plan *fftback_plan)
{
	int32_t i, j;
	Real_t real, imag;
...
void compute_gradient (Real_arr_t** g_real, Real_arr_t** g_imag, Real_arr_t** y_real, Real_arr_t** y_imag, Real_arr_t** Omega_real, Real_arr_t** Omega_imag, Real_arr_t** D_real, Real_arr_t** D_imag, Real_arr_t** w_real, Real_arr_t** w_imag, Real_arr_t** Lambda, Real_arr_t** v_real, Real_arr_t** v_imag, Real_t nu, int32_t rows, int32_t cols, Real_t delta_rows, Real_t delta_cols, fftw_complex *fftforward_arr, fftw_plan *fftforward_plan, fftw_complex *fftbackward_arr, fftw_plan *fftbackward_plan)
{
	...
	mult_OmegaHD (buf1_real, buf1_imag, Omega_real, Omega_imag, D_real, D_imag, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
	...
	mult_Herm_OmegaHD (buf1_real, buf1_imag, Omega_real, Omega_imag, D_real, D_imag, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
	...
	mult_Herm_OmegaHD (buf2_real, buf2_imag, Omega_real, Omega_imag, D_real, D_imag, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
...
Real_t compute_stepsize (Real_arr_t** g_real, Real_arr_t** g_imag, Real_arr_t** Omega_real, Real_arr_t** Omega_imag, Real_arr_t** D_real, Real_arr_t** D_imag, Real_arr_t** Lambda, Real_t nu, int32_t rows, int32_t cols, Real_t delta_rows, Real_t delta_cols, fftw_complex *fftforward_arr, fftw_plan *fftforward_plan, fftw_complex *fftbackward_arr, fftw_plan *fftbackward_plan)
{
	...
	mult_OmegaHD (buf_real, buf_imag, Omega_real, Omega_imag, D_real, D_imag, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
	...
	mult_Herm_OmegaHD (buf_real, buf_imag, Omega_real, Omega_imag, D_real, D_imag, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
...
Real_t compute_cost (Real_arr_t** y_real, Real_arr_t** y_imag, Real_arr_t** Omega_real, Real_arr_t** Omega_imag, Real_arr_t** D_real, Real_arr_t** D_imag, Real_arr_t** w_real, Real_arr_t** w_imag, Real_arr_t** Lambda, Real_arr_t** v_real, Real_arr_t** v_imag, Real_t nu, int32_t rows, int32_t cols, Real_t delta_rows, Real_t delta_cols, fftw_complex *fftforw_arr, fftw_plan *fftforw_plan, fftw_complex *fftback_arr, fftw_plan *fftback_plan)
{
	...
	mult_OmegaHD (buf_real, buf_imag, Omega_real, Omega_imag, D_real, D_imag, rows, cols, delta_rows, delta_cols, fftforw_arr, fftforw_plan, fftback_arr, fftback_plan);	
...
Real_t steepest_descent_iter (Real_arr_t** y_real, Real_arr_t** y_imag, Real_arr_t** Omega_real, Real_arr_t** Omega_imag, Real_arr_t** D_real, Real_arr_t** D_imag, Real_arr_t** w_real, Real_arr_t** w_imag, Real_arr_t** Lambda, Real_arr_t** v_real, Real_arr_t** v_imag, Real_t nu, int32_t rows, int32_t cols, Real_t delta_rows, Real_t delta_cols, fftw_complex *fftforward_arr, fftw_plan *fftforward_plan, fftw_complex *fftbackward_arr, fftw_plan *fftbackward_plan)
{
	...
	cost_old = compute_cost (y_real, y_imag, Omega_real, Omega_imag, D_real, D_imag, w_real, w_imag, Lambda, v_real, v_imag, nu, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
	compute_gradient (g_real, g_imag, y_real, y_imag, Omega_real, Omega_imag, D_real, D_imag, w_real, w_imag, Lambda, v_real, v_imag, nu, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
	alpha = compute_stepsize (g_real, g_imag, Omega_real, Omega_imag, D_real, D_imag, Lambda, nu, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
...
#ifdef EXTRA_DEBUG_MESSAGES
	cost_new = compute_cost (y_real, y_imag, Omega_real, Omega_imag, D_real, D_imag, w_real, w_imag, Lambda, v_real, v_imag, nu, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
	...
	compute_phase_projection (y_real, y_imag, Omega_real, Omega_imag, D_real, D_imag, w_real, w_imag, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan); 
#ifdef EXTRA_DEBUG_MESSAGES
	cost_new = compute_cost (y_real, y_imag, Omega_real, Omega_imag, D_real, D_imag, w_real, w_imag, Lambda, v_real, v_imag, nu, rows, cols, delta_rows, delta_cols, fftforward_arr, fftforward_plan, fftbackward_arr, fftbackward_plan);
	if (cost_new > cost_old)
	{
