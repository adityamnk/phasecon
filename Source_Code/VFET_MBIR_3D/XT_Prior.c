...
void FunctionalSubstitutionMRFPrior(Real_t *VMag, Real_t *VElec, Real_t THETA1_Mag[3], Real_t THETA2_Mag[3][3], Real_t THETA1_Elec, Real_t THETA2_Elec, ScannedObject* ScannedObjectPtr, TomoInputs* TomoInputsPtr, Real_t Mag_Nhood[3][3][3][3], Real_t Elec_Nhood[3][3][3], bool BDFlag[3][3][3])
{
  Real_t u_mag[3], u_elec, temp1_mag[3], temp1_elec, temp2_mag[3][3], temp3_mag[3][3], temp2_elec, Delta0_Mag[3], Delta0_Elec;
  ...
  temp3_mag[0][0] = 0; temp3_mag[0][1] = 0; temp3_mag[0][2] = 0; 
  temp3_mag[1][0] = 0; temp3_mag[1][1] = 0; temp3_mag[1][2] = 0;
  temp3_mag[2][0] = 0; temp3_mag[2][1] = 0; temp3_mag[2][2] = 0;
  ...
  for (i = 0; i < 3; i++)
  for (j = 0; j < 3; j++)
	temp3_mag[i][j] = THETA2_Mag[i][j] + temp2_mag[i][j];

  matinv(temp3_mag, temp2_mag);
...
void FunctionalSubstitutionConstPrior(Real_t *VMag, Real_t *VElec, Real_t THETA1_Mag[3], Real_t THETA2_Mag[3][3], Real_t THETA1_Elec, Real_t THETA2_Elec, ScannedObject* ScannedObjectPtr, TomoInputs* TomoInputsPtr, Real_t MagPrior[3], Real_t ElecPrior)
{
  Real_t u_mag[3], u_elec, temp1_mag[3], temp1_elec, temp2_mag[3][3], temp2_elec;
  int32_t i;
