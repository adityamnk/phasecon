...
mpiexec -n 1 -machinefile nodefile ./XT_Main --proj_rows 32 --proj_cols 128 --proj_num 128 --recon_num 1 --vox_wid 0.5 --rot_center 64 --mag_sig_s 0.00001 --mag_sig_t 1 --mag_c_s 0.000001 --mag_c_t 0.000001 --phase_sig_s 0.00005 --phase_sig_t 1 --phase_c_s 0.000001 --phase_c_t 0.000001 --convg_thresh 1 --obj2det_dist 100000 --xray_energy 3 --pag_regparam 97.8734 --critir > debug_critir.log 
